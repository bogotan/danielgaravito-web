...
const socialLinks = [
  {
    name: 'WhatsApp',
    href: 'https://wa.me/573166149797?text=Hola%20Daniel%2C%20vengo%20de%20danielgaravito.co',
    icon: (
  ...
  {
    name: 'LinkedIn',
    href: 'https://www.linkedin.com/in/daniel-alfonso-garavito-jim%C3%A9nez/',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'X',
    href: 'https://x.com/danielgaravitoco',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'Bluesky',
    href: 'https://bsky.app/profile/danielgaravito.co',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        <path d="M5.8 3.5C3.9 2 2 1.4 1 1.2V22c0 .3.2.5.5.5s.5-.2.5-.5v-7.3c1.3 3.1 4.7 4.3 7 4.3 1.6 0 2.6-.5 3-1.3.4.8 1.4 1.3 3 1.3 2.3 0 5.7-1.2 7-4.3V22c0 .3.2.5.5.5s.5-.2.5-.5V1.2c-1 .2-2.9.8-4.8 2.3-2 1.6-4.4 4.2-6.2 6.9C10.2 7.7 7.8 5.1 5.8 3.5z" />
      </svg>
    ),
  },
  {
    name: 'YouTube',
    href: 'https://youtube.com/@danielgaravito',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'TikTok',
    href: 'https://tiktok.com/@danielgaravito',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'Instagram',
    href: 'https://instagram.com/danielgaravito.co',
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: 'Email',
    href: 'mailto:dagaravitoj@gmail.com',
    icon: (
